...
## 7-Segment Display — digit enables (active low)
...
## Debug outputs mapped to Pmod JA (top row)
...
set_property PACKAGE_PIN G2  [get_ports {r1_debug[0]}]
set_property PACKAGE_PIN H1  [get_ports {r1_debug[1]}]
set_property PACKAGE_PIN K2  [get_ports {r1_debug[2]}]
set_property PACKAGE_PIN H2  [get_ports {r1_debug[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pc_debug[*]}]
set_property IOSTANDARD LVCMOS33 [get_ports {r1_debug[*]}]
